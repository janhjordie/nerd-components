...
| HR-006 | P0 | in_progress | Portal-aware Pickers | Date/Time/Select/Menu-popovers arver token-klasse; Playwright bekræfter `dnf-*` på `.mud-popover-open` | Shared portal bridge + catalog token hosts; automated build pending | DT-FEATURE-06 · ROADMAP-F0 |
...
| HR-033 | P1 | open | Save as Client Typography Pack | `INerdTypographyPackStore` + JSON; “Gem som klient” i catalog | | RT-FEATURE-04 · RT-ROADMAP-F2 |
| HR-034 | P2 | open | Modular Scale Generator | Input base + ratio → generér alle roller + clamp wrap | | RT-FEATURE-05 |
| HR-035 | P1 | open | Live Clamp Editor | Sliders min/preferred/max + live MudText preview i catalog | | RT-FEATURE-06 |
...
| HR-040 | P1 | open | Typography snapshot tests | bUnit: computed sizes ved 320/768/1280/1920 for presets | | RT-ROADMAP-F0 |
...
| HR-054 | P1 | open | Fix Demo `AddAdditionalAssemblies` dedupe | `TheNerdCollective.Demo` starter uden “Assembly already defined” | | AGENTS.md |
