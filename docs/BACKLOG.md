...
| HR-022 | P1 | in_progress | Token pack loaders | `FromJson`, `FromPreset("dnf")`, merge med `FromOptions` | `FromJson` + `FromOptions` + `FromPreset("dnf")`; merge hardening pending | DT-ROADMAP-F1 |
