...
- **Azure Functions guide** med HTTP API og Postman collection — se [Azure Functions API-guiden på GitHub](https://github.com/janhjordie/nerd-components/blob/main/src/TheNerdCollective.Integrations.Dar/AZURE-FUNCTIONS-API.md)
...
Se **[Azure Functions API-guiden på GitHub](https://github.com/janhjordie/nerd-components/blob/main/src/TheNerdCollective.Integrations.Dar/AZURE-FUNCTIONS-API.md)** for komplet guide med:
...
- [Postman collection på GitHub](https://github.com/janhjordie/nerd-components/blob/main/src/TheNerdCollective.Integrations.Dar/postman/TheNerdCollective.Integrations.Dar.postman_collection.json) med alle requests
