# MudBlazor 9.8.0 — CSS analysis (HR-130)

## 1. Scope

| Field | Value |
|-------|-------|
| MudBlazor NuGet | 9.8.0 |
| GitHub tag | v9.8.0 |
...
```bash
# Source SCSS (verify against tag v9.8.0)
# https://github.com/MudBlazor/MudBlazor/tree/v9.8.0/src/MudBlazor/Styles/components

# Compiled CSS (optional hash in sources/)
# https://github.com/MudBlazor/MudBlazor/blob/v9.8.0/src/MudBlazor/wwwroot/MudBlazor.min.css
```

Full automated harvest: **HR-133** (pending). This document is the committed baseline for adapter work on 9.8.0.
