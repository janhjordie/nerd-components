# MudBlazor 9.8.0 — palette manifest

Source: `MudThemeProvider.GenerateTheme` @ [v9.8.0](https://github.com/MudBlazor/MudBlazor/blob/v9.8.0/src/MudBlazor/Components/ThemeProvider/MudThemeProvider.razor.cs)
